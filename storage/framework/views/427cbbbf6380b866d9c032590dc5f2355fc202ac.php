                    ...
                    <tr >
                        ...
                        <td style="color:white;">
                           ...
                           <a class="button" href="<?php echo e(url('turbines/'.$turbine->name.'/view-systems')); ?>?id=<?php echo e($turbine->id); ?>">Systems</a>
                            ...
                            <a class="button update" data-turbine_id="<?php echo e($turbine->id); ?>" data-turbine="<?php echo e($turbine->name); ?>" data-type="<?php echo e($turbine->shutdown_for()); ?>"  href="#">Update Logs</a>
               ...
               var turbine  = '<b>'+$(this).data('turbine')+'</b>';
                var posting = $.post( '<?php echo e(url("turbine/logs")); ?>',  { turbine_id : turbine_id,_token: '<?php echo e(csrf_token()); ?>'} ).done(function( data ) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                       content += '<tr><td>'+data[i]['inspection_type']+'</td>'+'<td>'+data[i]['proposed_hours']+'</td>'+'<td>'+data[i]['actual_hours']+'</td>'+'<td>'+data[i]['actual_date']+'</td>'+'<td>'+data[i]['total_fails']+'</td>'+'<td>'+data[i]['remark']+'</td></tr>';
                    }
