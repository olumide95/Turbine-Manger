        ...
        <div class="container">
            ...
            <div class="left-side">
                ...
                <div id="logo" style="background-color: white">
                    <a href="{{url('/')}}"><img src="{{url('images/logo.jpeg')}}" alt="" style="    max-height: 100px;"></a>
                    <a href="{{url('/')}}" class="dashboard-logo"><img src="{{url('images/logo.jpeg')}}" alt="" style="    max-height: 78px;"></a>
                </div>
    ...
    <div class="dashboard-nav">
        <div class="dashboard-nav-inner" style="max-height: 440px;">
            ...
            <ul data-submenu-title="Main">
                <li>
                  <a href="{{ url('/') }}"><i class="sl sl-icon-screen-desktop"></i>Dashboard</a></li>
                 
                            
                    <li><a href="{{ url('/turbines') }}"><i class="fa fa-ticket"></i> Turbines</a> </li>
                      <li><a href="{{ url('/device/add') }}"><i class="fa fa-ticket"></i> Add Device</a>
...
================================================== -->
  ...
  <script type="text/javascript" src="{{url('scripts/jquery-1.12.4.js')}}"></script>
<script src="//code.jquery.com/ui/1.11.2/jquery-ui.js"></script>
<script type="text/javascript" src="{{url('scripts/popper.min.js')}}"></script>
  <script type="text/javascript" src="{{url('scripts/bootstrap.js')}}"></script>
<script src="{{url('scripts/toastr.min.js')}}"></script>
